...
|---:|---|---|---|---:|---:|---|---|---|
| 0 | Startup Simulator | Pipeline ready: FOUP A 5 wafers, FOUP B empty | Home / Start | 5/5 | 0/5 | Chamber A:Empty::PreClean_Default:-:0s:0%<br>Chamber B:Empty::CMP_Main:-:0s:0%<br>Chamber C:Empty::PostClean_Dry:-:0s:0% | A:Closed B:Closed C:Closed<br>Retracted<br>Off | [00-startup-simulator.png](screenshots/00-startup-simulator.png) |
...
| 2 | Z Work At FOUP A Slot A1 | Z moving to FOUP A Slot A1 height | FOUP A | 5/5 | 0/5 | Chamber A:Empty::PreClean_Default:-:0s:0%<br>Chamber B:Empty::CMP_Main:-:0s:0%<br>Chamber C:Empty::PostClean_Dry:-:0s:0% | A:Closed B:Closed C:Closed<br>Retracted<br>Off | [02-z-work-foup-a-slot-a1.png](screenshots/02-z-work-foup-a-slot-a1.png) |
| 5 | W01 On Blade From FOUP A Slot A1 | W01 picked onto blade | FOUP A | 4/5 | 0/5 | Chamber A:Empty::PreClean_Default:-:0s:0%<br>Chamber B:Empty::CMP_Main:-:0s:0%<br>Chamber C:Empty::PostClean_Dry:-:0s:0% | A:Closed B:Closed C:Closed<br>Extended<br>SuctionOn | [02-blade-holding-wafer-after-pickup.png](screenshots/02-blade-holding-wafer-after-pickup.png) |
...
| 25 | Blade Extending Into Chamber A | Blade extending into Chamber A | Chamber A | 4/5 | 0/5 | Chamber A:Completed:W01:PreClean_Default:Chem Clean:0s:100%<br>Chamber B:Empty::CMP_Main:-:0s:0%<br>Chamber C:Empty::PostClean_Dry:-:0s:0% | A:Open B:Closed C:Closed<br>Extending<br>Off | [08-chamber-a-unload-after-process-complete.png](screenshots/08-chamber-a-unload-after-process-complete.png) |
| 431 | Sequence Complete - FOUP B 5/5 | All 5 wafers complete in FOUP B | FOUP B | 0/5 | 5/5 | Chamber A:Empty::PreClean_Default:-:0s:0%<br>Chamber B:Empty::CMP_Main:-:0s:0%<br>Chamber C:Empty::PostClean_Dry:-:0s:0% | A:Closed B:Closed C:Closed<br>Retracted<br>Off | [09-final-foup-b-5-completed.png](screenshots/09-final-foup-b-5-completed.png) |
| 432 | Reset Safe State | Reset to safe simulator state | Home / Start | 5/5 | 0/5 | Chamber A:Empty::PreClean_Default:-:0s:0%<br>Chamber B:Empty::CMP_Main:-:0s:0%<br>Chamber C:Empty::PostClean_Dry:-:0s:0% | A:Closed B:Closed C:Closed<br>Retracted<br>Off | [10-reset-safe-state.png](screenshots/10-reset-safe-state.png) |
...
|---|---|
| [00-startup-simulator.png](screenshots/00-startup-simulator.png) | Home/start position. FOUP A starts with W01-W05 waiting. Blade retracted, vacuum off, all chamber doors closed. |
| [01-foup-a-before-pickup.png](screenshots/01-foup-a-before-pickup.png) | Theta target FOUP A Slot A1; preparing to pick W01. |
| [02-z-work-foup-a-slot-a1.png](screenshots/02-z-work-foup-a-slot-a1.png) | Z reaches the selected slot/stage before blade extension. |
...
- `docs/debug/latest/screenshots/02-z-work-foup-a-slot-a1.png`
